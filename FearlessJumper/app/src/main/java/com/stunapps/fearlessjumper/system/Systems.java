...
import com.stunapps.fearlessjumper.system.update.RevolvingMotionSystem;
...
public class Systems
{
	...
	private static final List<Class<? extends UpdateSystem>> systemOrder =
			Arrays.asList(InputUpdateSystem.class, PhysicsSystem.class, GenerationSystem.class,
						  MovementUpdateSystem.class, CollisionSystem.class,
						  LowerBoundarySystem.class, TransformUpdateSystem.class,
						  ScoreUpdateSystem.class, RevolvingMotionSystem.class,
